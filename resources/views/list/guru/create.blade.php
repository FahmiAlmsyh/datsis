            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Tambah List Guru</h3>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Tambah List Guru</h4>
                                    ...
                                    <form action="{{ route('guru.store') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="kelas_id" id="kelas">
                                                @forelse ($kelas as $p)
                                                    <option value="{{ $p->id }}" @selected($p->id == old('kelas_id'))
                                                        selected>
                                                        {{ $p->nama }}</option>
                                                @empty
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="mapel" id="mapel"
                                                aria-describedby="helpId" placeholder="Masukkan Mata Pelajaran" />
                                        </div>
